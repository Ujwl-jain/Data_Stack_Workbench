...
---------
-- Q23. Query the difference between the maximum and minimum populations in CITY.

SELECT (MAX(POPULATION) - MIN(POPULATION))
FROM CITY

---------
-- Q24. Given the CITY and COUNTRY tables, query the sum of the populations of all cities where the CONTINENT is 'Asia'.
-- Note: CITY.CountryCode and COUNTRY.Code are matching key columns.
...
-- Q25. We define an employee's total earnings to be their monthly (month * salary) worked, and the maximum total earnings to be the maximum total earnings for any employee in the 
...
-- ---------
-- Q26. Samantha was tasked with calculating the average monthly salaries for all employees in the EMPLOYEES table, but did not realize her keyboard's 0 key was broken until 
-- after completing the calculation. She wants your help finding the difference between her miscalculation (using salaries with any zeros removed), and the actual average salary.
