# Dictonaries
# we can create mapping using dictonries, to create a mapping between 2 different co related things in key value pair

# dictonries are ordered collection of data items, they store multiple items in a single variable
...
print(dict1['ujjwal'])  #-> this will throw an error if key does not exist
print(dict1.get('ujjwal')) #-> this will return none if key does not exist
...
for key in dict1.keys():
    print(f'the all keys value of the {key} are: {dict1[key]}')

print(dict1.items())

for key,value in dict1.items():
    print(f'the all keys value of the {key} are: {value}')
...
# update()
# update the items in the dictonary, since it is ordered the updated items will go to last 
...
# clear ()
# remove all items from dictonary and return an empty dictonary
...
# pop()
# remove a particular item in dictonary
...
# popitem()
# remove the last item in dictonary
dict_popitem  = {122 : 45, 123 : 89, 124:69, 167: 78}
dict_popitem.popitem(122)
print(dict_popitem)
...
# del dict_del  # delete the entire dictonry
