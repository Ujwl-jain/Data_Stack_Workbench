# Loops - process of doing some function multiple times
...
# --------------------------- FOR LOOP ---------------------------
# process of iterate over a sequence of iterable objects. 
# iterable - list, tuple, dictionary, sets, string
# SYNTAX:
...
# ------- Range ------------
# range function - it can help if we want to use for loop for a specific number of time

# means n-1 here, if there is 5 so it will go from 5-1 = 4, starts from 0 just like indexing
for i in range(5):  # by default for i in range(0,5): and 5 will be n-1 
    print(i)

# here it wil print from 1 to n-1 which 10-1 = 9
for i in range(1,10):
    print(i) 

# there are 3 parameters which are start, stop, step 
# this thing is like list and string
# for example:
# for i in range(1,10,2)
# here 1 is start means it will start from 1 number
# 10 is stop it will stop at n-1 which is 10-1, 9
# and 2 means it will step by skipping 1 number each time


#  ---------------------------- enumerate -------------------
# it is a built in function that allows youto loop over a sequence and get the index and value at the same time

# complex method to get the indexing work
list_en = [12,34,124,556,231]
index = 0
for mark in list_en:
    print(mark)
    if index == 3:
...
# using enumerate we can simplify this


# for v in enumerate(list_en, start = 0):  # here v will return the tuple of index and mark 

# by default indexin will start from 0 but you can start from anywhere lets say 1
for index, mark in enumerate(list_en, start = 1):  # here you will get the index and mark as unpacked
    print(index, mark)
    if index == 3:
        print("index")

# -------------------------- WHILE LOOP ---------------------------
# both are same works same syntax different 
# but synatax differ and any loop can be convineint at the time of situation
# while loop execute the loop as long as the condition is satisfy, as the condition become false it will come out of loop
# example:
i = 0
while i<=3:
    print(i)
...
# While loop idealy not prefer to used wiith numbers but mainly used with complex conditons
# for example:
# lets say user gives the input untill a certain condition:
i = int(input("enter a number: "))      #initialise a number to run the code otherwise it will not work
while i<=38:                            # will keep asking user for the input until this condition gets falsed
    i = int(input("enter a number: "))
    print(i)

print("done with the loop")

# we need to either increment or decrement based on the situation otherwise while loop will keep on runnning - infinite loop
count = 7
while(count>0):
    print(count)
    count = count - 1 # here if there is plus sign it will keep on running cause condition will keep satisfied every time

# ----------------------- else with while loop ---------------------------
# Once the while loop condition gets false else block will get executed
count = -427
while(count>0):
    print(count)
    count = count - 1 
...
# ------------------------ Break And Continue ----------------------------------
# Break - skip over a part of code, it terminate the loop it lies within
# means - loop ko chrd kr nikal jaou
for i in range(1,12):
    if i == 9:
        break               # this will break the condition after the 9th iteration comes 
    print(5*i)
print("loop gets break after a certain condition")


# Continue - iteration ko chrd kr nikal jaou
for i in range(1,12):
    if i == 9:
        print("skip the iteration")
        continue              # this will skip the iteration after the 9th iteration comes 
    print(5*i)                # it will skip the 9th iteration and goes straight to 10th and onwards
print("iteration gets skipped after a certain condition")
...
# the statement of the else block will be executed once loop is finished iterated like below example:
...
#  Below code will not work as it is break mid ways befoe completing the loop,
#  else block wll only be executed once the loop is finished successfully till the end
for i in range(5):
    print(i)
    if i == 3:    
        break
